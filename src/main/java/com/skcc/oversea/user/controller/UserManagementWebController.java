...
import com.skcc.oversea.user.domain.SecurityPolicy;
import com.skcc.oversea.user.domain.User;
import com.skcc.oversea.user.domain.UserActivity;
import com.skcc.oversea.user.service.SecurityPolicyService;
import com.skcc.oversea.user.service.UserActivityService;
...
public class UserManagementWebController {
    ...
    public String userRegisterPage(Model model) {
        ...
        model.addAttribute("user", new com.skcc.oversea.user.domain.User());
    ...
    public String registerUser(@ModelAttribute("user") com.skcc.oversea.user.domain.User user, Model model) {
        ...
        try {
            ...
            if (user.getStatus() == null) {
                user.setStatus(com.skcc.oversea.user.domain.UserStatus.ACTIVE);
            }
    ...
    public String userActivityLogsPage(
        ...
        model.addAttribute("title", "사용자 활동 로그");
        model.addAttribute("activities", activities);
        model.addAttribute("userId", userId);
    ...
    public String testPage(Model model) {
        ...
        model.addAttribute("title", "클릭 이벤트 테스트");
    ...
    public String debugPage(Model model) {
        ...
        model.addAttribute("title", "디버그 테스트");
    ...
    public String simpleTestPage(Model model) {
        ...
        model.addAttribute("title", "간단한 클릭 테스트");
