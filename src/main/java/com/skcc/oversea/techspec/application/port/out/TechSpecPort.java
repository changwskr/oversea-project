package com.skcc.oversea.techspec.application.port.out;
...
public interface TechSpecPort {
     ...
     * 기술 스펙 검색
     */
    List<TechSpec> findBySearchCriteria(String category, String technologyName, String subItem, String version, String keyword);
