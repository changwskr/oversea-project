package com.skcc.oversea.techspec.infrastructure.adapter;

import com.skcc.oversea.techspec.application.port.out.TechSpecPort;
...
public class TechSpecPersistenceAdapter implements TechSpecPort {
    ...
    @Override
    public List<TechSpec> findBySearchCriteria(String category, String technologyName, String subItem, String version, String keyword) {
        log.info("Finding tech specs by search criteria - category: {}, technologyName: {}, subItem: {}, version: {}, keyword: {}", 
