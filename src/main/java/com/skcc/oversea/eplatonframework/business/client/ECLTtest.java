...
import com.skcc.oversea.cashCard.transfer.AccountQueryCDTO;
...
public class ECLTtest
{
  ...
  public EPlatonEvent execute(EPlatonEvent event) throws Exception
  {
    ...
    try{
      ...
      System.out.println("SEND-"+com.skcc.oversea.foundation.utility.Reflector.objectToString(resevent));
