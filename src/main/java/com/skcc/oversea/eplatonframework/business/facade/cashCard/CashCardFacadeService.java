...
public class CashCardFacadeService {
    ...
    public CashCard getCashCardById(String cardId) {
        ...
        try {
            ...
            logger.error("==================[CashCardFacadeService.getCashCardById ERROR] - 카드ID: {}, 에러: {}", cardId, e.getMessage(), e);
            throw e;
        }
    }
    ...
    public CashCard createCashCard(CashCard cashCard) {
        ...
        try {
            ...
            logger.info("==================[CashCardFacadeService.createCashCard END] - 카드번호: {}", cashCard.getCardNo());
            return result;
        } catch (Exception e) {
            logger.error("==================[CashCardFacadeService.createCashCard ERROR] - 카드번호: {}, 에러: {}", cashCard.getCardNo(), e.getMessage(), e);
            throw e;
        }
    }
    ...
    public void deleteCashCard(String cardId) {
        ...
        try {
            ...
            logger.error("==================[CashCardFacadeService.deleteCashCard ERROR] - 카드ID: {}, 에러: {}", cardId, e.getMessage(), e);
            throw e;
        }
    }
    ...
    public boolean existsCashCard(String cardId) {
        ...
        try {
            ...
            logger.error("==================[CashCardFacadeService.existsCashCard ERROR] - 카드ID: {}, 에러: {}", cardId, e.getMessage(), e);
            throw e;
        }
    }
}