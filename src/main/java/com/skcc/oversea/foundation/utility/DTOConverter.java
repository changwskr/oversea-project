...
import com.skcc.oversea.framework.transaction.model.TransactionUpDownDDTO;
...
public class DTOConverter
{
  ...
  public static TransactionUpDownDDTO getTransactionUpDownDDTO(EPlatonEvent event)
  {
    ...
    if( reqcdto != null ){
      transactionUPDOWNDDTO.setRequest_cdto(com.skcc.oversea.foundation.utility.Reflector.objectToString(event.getRequest()));
    }
    if( rescdto != null ){
      transactionUPDOWNDDTO.setResponse_cdto(com.skcc.oversea.foundation.utility.Reflector.objectToString(event.getResponse()));
    }
